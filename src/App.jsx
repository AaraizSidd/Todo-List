...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="container mx-auto my-5 rounded p-5 bg-violet-100 min-h-[80vh] w-1/2">
      <h1 className="font-bold text-center text-xl">Manage your todos at one place</h1>
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button
            ...
            className="bg-violet-800 hover:bg-violet-950 disabled:bg-violet-700
              p-3 py-1 text-white rounded-md"
          >
            Save
          </button>
        </div>
         ...
         return (showFinished || !item.isCompleted) && <div key={item.id} className="todo flex w-1/2 my-3 justify-between">
          ...
          <input name={item.id} onChange={handleCheckbox} type="checkbox" checked={item.isCompleted} id="" />
            ...
            <div className="buttons flex h-full ">
              ...
              p-3 py-1 text-white rounded-md mx-1"
              >
                Edit
              </button>
